...
## SELECT ProductName, CategoryName FROM Product JOIN Category ON Product.id = Category.id; 

-- Display the order Id and shipper CompanyName for all orders placed before August 9 2012. Shows 429 records.

## SELECT [Order].Id as OrderId, Shipper.CompanyName FROM [Order] JOIN Shipper ON [Order].ShipVia = Shipper.Id where OrderDate < '2012-08-09';
